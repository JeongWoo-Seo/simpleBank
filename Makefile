...
migrateup:
	migrate -path db/migration -database "postgres://root:oxa3Yp9G4jSOLm8CSpcC@simple-bank.c5u2ygyc6ljx.ap-northeast-2.rds.amazonaws.com:5432/simple_bank" -verbose up
