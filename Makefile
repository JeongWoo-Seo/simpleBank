...
mock:
	mockgen -package mockdb -destination db/mock/store.go github.com/JeongWoo-Seo/simpleBank/db/sqlc Store
	mockgen -package mockwk -destination worker/mock/distributor.go github.com/JeongWoo-Seo/simpleBank/worker TaskDistributor
